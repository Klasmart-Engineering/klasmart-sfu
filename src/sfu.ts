...
import { createWorker, observer, types as MediaSoup } from "mediasoup";
...
export class SFU {
        ...
        do {
            ...
            for (const key of keys) {
                try {
                    ...
                    if(value !== null) {
                        if(value) { availableCount++; } else { otherCount++; }
                    }
                } catch(e) {
                    console.error(e);
                }
    ...
    @newRelicTransaction("rtpCapabilities")
    ...
    @newRelicTransaction("updateGlobalMute")
    ...
    @newRelicTransaction("retrieveGlobalMute")
    ...
    @newRelicTransaction("retrieveMuteStatuses")
